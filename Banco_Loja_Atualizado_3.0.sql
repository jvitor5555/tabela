...
(1, "Camiseta do Gremio", "Camiseta com listras nas cores azul, preta e branca", 89.95, 15),
(2, "Notebook compaq presario", "computador portatil pentium", 3300, 3.5),
(3, "Monitor Samsung", "Monitor colorido de 14 polegadas", 450, 8.3),
(4, "Cafeteira", "cafeteira 14 xicaras arno", 55.50, 5.4),
(5, "Caneta bic", "Pacote com três unidades", 4.50, 0.3);

UPDATE Produto 
SET Preco_Produto = 80
WHERE Cod_Produto = 1; 
